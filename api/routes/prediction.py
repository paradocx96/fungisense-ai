...
@router.post("/predict/complete", response_model=CompletePredictionResponse)
...
@router.post("/predict/species", response_model=dict)
...
@router.post("/predict/safety", response_model=dict)
...
@router.post("/predict/foraging", response_model=dict)
