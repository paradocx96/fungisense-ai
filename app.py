...
def input_data_maker(data):
    if data:
        ...
        cap_shape = color_mapping.get(data.get("cap-shape"), "unknown")
        cap_surface = color_mapping.get(data.get("cap-surface"), "unknown")
        cap_color = color_mapping.get(data.get("cap-color"), "unknown")
        bruises = color_mapping.get(data.get("bruises"), "unknown")
        odor = color_mapping.get(data.get("odor"), "unknown")
        gill_attachment = color_mapping.get(data.get("gill-attachment"), "unknown")
        gill_spacing = color_mapping.get(data.get("gill-spacing"), "unknown")
        gill_size = color_mapping.get(data.get("gill-size"), "unknown")
        gill_color = color_mapping.get(data.get("gill-color"), "unknown")
        stalk_shape = color_mapping.get(data.get("stalk-shape"), "unknown")
        stalk_root = color_mapping.get(data.get("stalk-root"), "unknown")
        stalk_surface_above_ring = color_mapping.get(data.get("stalk-surface-above-ring"), "unknown")
        stalk_surface_below_ring = color_mapping.get(data.get("stalk-surface-below-ring"), "unknown")
        stalk_color_above_ring = color_mapping.get(data.get("stalk-color-above-ring"), "unknown")
        stalk_color_below_ring = color_mapping.get(data.get("stalk-color-below-ring"), "unknown")
        veil_type = color_mapping.get(data.get("veil-type"), "unknown")
        veil_color = color_mapping.get(data.get("veil-color"), "unknown")
        ring_number = color_mapping.get(data.get("ring-number"), "unknown")
        ring_type = color_mapping.get(data.get("ring-type"), "unknown")
        spore_print_color = color_mapping.get(data.get("spore-print-color"), "unknown")
